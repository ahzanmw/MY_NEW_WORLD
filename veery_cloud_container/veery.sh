...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"eventmonitor:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"eventmonitor:"$VERSION_TAG "eventmonitor:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"eventmonitor:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/eventmonitor/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_VERSION=$HOST_VERSION" --env="HOST_EVENTMONITOR_PORT=8806" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_REDIS_DB=$REDIS_DB_PROCESSEDCDR" --env="SYS_MONGO_HOST=$MONGO_HOST" --env="SYS_MONGO_USER=$MONGO_USER" --env="SYS_MONGO_PASSWORD=$MONGO_PASSWORD"  --env="SYS_MONGO_DB=$MONGO_DB" --env="SYS_MONGO_PORT=$MONGO_PORT" --env="SYS_MONGO_REPLICASETNAME=$MONGO_REPLICA_SET_NAME" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="HOST_EVENT_CONSUME_TYPE=$EVENT_CONSUME_TYPE" --env="SYS_ARDSLITESERVICE_HOST=ardsliteservice.$FRONTEND" --env="SYS_ARDSLITESERVICE_NODE_CONFIG_DIR=/usr/local/src/ardsliteservice/config" --env="SYS_ARDSLITESERVICE_PORT=8828" --env="SYS_ARDSLITESERVICE_VERSION=$HOST_VERSION" --env="SYS_DIALER_HOST=dialerapi.$FRONTEND" --env="HOST_USE_DASHBOARD_MSG_QUEUE=$DASHBOARD_USE_MSG_QUEUE" --env="SYS_DIALER_GO_CONFIG_DIR=/go/src/github.com/DuoSoftware/DVP-DialerAPI/DuoDialer" --env="SYS_DIALER_PORT=8836" --env="SYS_NOTIFICATIONSERVICE_HOST=notificationservice.$FRONTEND" --env="SYS_NOTIFICATIONSERVICE_PORT=8833" --env="SYS_INTERACTIONS_HOST=interactions.$FRONTEND" --env="SYS_INTERACTIONS_VERSION=$HOST_VERSION" --env="SYS_FREESWITCH_HOST=$FREESWITCH_HOST" --env="SYS_FREESWITCH_EVENTSOCKET_PASSWORD=$FREESWITCH_EVENTSOCKET_PASSWORD" --env="SYS_XMLRPC_PORT=$XMLRPC_PORT" --env="SYS_EVENTSOCKET_PORT=$EVENTSOCKET_PORT" --env="VIRTUAL_HOST=eventmonitor.*" --env="LB_FRONTEND=eventmonitor.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8806/tcp --log-opt max-size=10m --log-opt max-file=10 --restart=always --name eventmonitor eventmonitor:$VERSION_TAG node /usr/local/src/eventmonitor/app.js;
;;
   "queuemusic")
#26
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"queuemusic:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"queuemusic:"$VERSION_TAG "queuemusic:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"queuemusic:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="NODE_CONFIG_DIR=/usr/local/src/queuemusic/config" --env="HOST_TOKEN=$HOST_TOKEN" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="HOST_NAME=queuemusic" --env="HOST_QUEUEMUSIC_PORT=8843" --env="HOST_IP=$HOST_IP" --env="HOST_VERSION=$HOST_VERSION" --env="VIRTUAL_HOST=queuemusic.*" --env="LB_FRONTEND=queuemusic.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8843/tcp --log-opt max-size=10m --log-opt max-file=10 --restart=always --name queuemusic queuemusic:$VERSION_TAG node /usr/local/src/queuemusic/app.js;
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"appregistry:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"appregistry:"$VERSION_TAG "appregistry:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"appregistry:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"autoattendant:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"autoattendant:"$VERSION_TAG "autoattendant:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"autoattendant:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
if [ $REPOSITORY = "local" ]; then
IFS='.' read -ra VER <<< "$GO_VERSION_TAG"
 docker pull $REPOSITORY_IPURL":5000"/"dialerapi:"$GO_VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"dialerapi:"$GO_VERSION_TAG "dialerapi:"$GO_VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"dialerapi:"$GO_VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
if [ $REPOSITORY = "local" ]; then
IFS='.' read -ra VER <<< "$GO_VERSION_TAG"
 docker pull $REPOSITORY_IPURL":5000"/"dashboard:"$GO_VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"dashboard:"$GO_VERSION_TAG "dashboard:"$GO_VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"dashboard:"$GO_VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"cdrprocessor:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"cdrprocessor:"$VERSION_TAG "cdrprocessor:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"cdrprocessor:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"eventservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"eventservice:"$VERSION_TAG "eventservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"eventservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"liteticket:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"liteticket:"$VERSION_TAG "liteticket:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"liteticket:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"httpprogrammingmonitorapi:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"httpprogrammingmonitorapi:"$VERSION_TAG "httpprogrammingmonitorapi:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"httpprogrammingmonitorapi:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"scheduleworker:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"scheduleworker:"$VERSION_TAG "scheduleworker:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"scheduleworker:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"cdrgenerator:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"cdrgenerator:"$VERSION_TAG "cdrgenerator:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"cdrgenerator:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"productivityservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"productivityservice:"$VERSION_TAG "productivityservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"productivityservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"mailreceiver:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"mailreceiver:"$VERSION_TAG "mailreceiver:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"mailreceiver:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"socialconnector:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"socialconnector:"$VERSION_TAG "socialconnector:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"socialconnector:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"todolistservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"todolistservice:"$VERSION_TAG "todolistservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"todolistservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"walletservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"walletservice:"$VERSION_TAG "walletservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"walletservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"billingservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"billingservice:"$VERSION_TAG "billingservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"billingservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"integrationapi:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"integrationapi:"$VERSION_TAG "integrationapi:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"integrationapi:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"dashboardservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"dashboardservice:"$VERSION_TAG "dashboardservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"dashboardservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"qamodule:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"qamodule:"$VERSION_TAG "qamodule:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"qamodule:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"csatservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"csatservice:"$VERSION_TAG "csatservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"csatservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"diameterrelay:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"diameterrelay:"$VERSION_TAG "diameterrelay:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"diameterrelay:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"diameterclient:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"diameterclient:"$VERSION_TAG "diameterclient:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"diameterclient:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"diameterserver:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"diameterserver:"$VERSION_TAG "diameterserver:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"diameterserver:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"skypebot:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"skypebot:"$VERSION_TAG "skypebot:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"skypebot:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"contacts:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"contacts:"$VERSION_TAG "contacts:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"contacts:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"crmintegrations:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"crmintegrations:"$VERSION_TAG "crmintegrations:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"crmintegrations:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"carrierprovider:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"carrierprovider:"$VERSION_TAG "carrierprovider:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"carrierprovider:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"agentdialerservice:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"agentdialerservice:"$VERSION_TAG "agentdialerservice:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"agentdialerservice:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
if [ $REPOSITORY = "local" ]; then
IFS='.' read -ra VER <<< "$GO_VERSION_TAG"
 docker pull $REPOSITORY_IPURL":5000"/"filearchiveservice:"$GO_VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"filearchiveservice:"$GO_VERSION_TAG "filearchiveservice:"$GO_VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"filearchiveservice:"$GO_VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
docker build --build-arg VERSION_TAG=$GO_VERSION_TAG -t "filearchiveservice:"$GO_VERSION_TAG .;
fi
cd /usr/src/;
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro -v $FILE_DIRECTORY_PATH:/usr/local/src/upload --env="VERSION_TAG=$GO_VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env="GO_CONFIG_DIR=/go/src/github.com/DuoSoftware/DVP-FileArchiveService" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_IP=$HOST_IP" --env="HOST_VERSION=$HOST_VERSION" --env="SYS_USERSERVICE_HOST=userservice.$FRONTEND" --env="SYS_USERSERVICE_VERSION=$HOST_VERSION" --log-opt max-size=10m --log-opt max-file=10 --restart=always --name filearchiveservice filearchiveservice:$GO_VERSION_TAG go run *.go;
;;
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"smppclient:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"smppclient:"$VERSION_TAG "smppclient:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"smppclient:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
...
if [ ! -d "DVP-DashboardDataProcessor" ]; then
...
cd /usr/src/;
if [ $REPOSITORY = "local" ]; then
 docker pull $REPOSITORY_IPURL":5000"/"eventsink:"$VERSION_TAG;
 docker tag $REPOSITORY_IPURL":5000"/"eventsink:"$VERSION_TAG "eventsink:"$VERSION_TAG;
 docker rmi -f $REPOSITORY_IPURL":5000"/"eventsink:"$VERSION_TAG;
elif [ $REPOSITORY = "github" ]; then
if [ ! -d "DVP-EventSink" ]; then
	git clone -b $VERSION_TAG https://github.com/DuoSoftware/DVP-EventSink.git
fi

cd DVP-EventSink;
docker build --build-arg VERSION_TAG=$VERSION_TAG -t "eventsink:"$VERSION_TAG .;
fi
cd /usr/src/;
docker run -d -t --memory="512m" -v /etc/localtime:/etc/localtime:ro --env="VERSION_TAG=$VERSION_TAG" --env="COMPOSE_DATE=$DATE" --env='NODE_CONFIG_DIR=/usr/local/src/eventsink/config' --env="HOST_EVENTSINK_PORT=8822" --env="HOST_TOKEN=$HOST_TOKEN" --env="HOST_VERSION=$HOST_VERSION" --env="SYS_DATABASE_HOST=$DATABASE_HOST" --env="SYS_DATABASE_TYPE=$DATABASE_TYPE" --env="SYS_DATABASE_POSTGRES_USER=$DATABASE_POSTGRES_USER" --env="SYS_DATABASE_POSTGRES_PASSWORD=$DATABASE_POSTGRES_PASSWORD" --env="SYS_SQL_PORT=$SQL_PORT" --env="SYS_REDIS_HOST=$REDIS_HOST" --env="SYS_REDIS_PASSWORD=$REDIS_PASSWORD" --env="SYS_REDIS_PORT=$REDIS_PORT" --env="SYS_REDIS_MODE=$REDIS_MODE" --env="SYS_REDIS_SENTINEL_HOSTS=$REDIS_SENTINEL_HOSTS" --env="SYS_REDIS_SENTINEL_PORT=$REDIS_SENTINEL_PORT" --env="SYS_REDIS_SENTINEL_NAME=$REDIS_SENTINEL_NAME" --env="SYS_RABBITMQ_HOST=$RABBITMQ_HOST" --env="SYS_RABBITMQ_PORT=$RABBITMQ_PORT" --env="SYS_RABBITMQ_USER=$RABBITMQ_USER" --env="SYS_RABBITMQ_PASSWORD=$RABBITMQ_PASSWORD" --env="SYS_RABBITMQ_VHOST=$RABBITMQ_VHOST" --env="SYS_EVENT_CONSUME_TYPE=$EVENT_CONSUME_TYPE" --env="VIRTUAL_HOST=eventsink.*" --env="LB_FRONTEND=eventsink.$FRONTEND" --env="LB_PORT=$LB_PORT" --expose=8838/tcp --log-opt max-size=10m --log-opt max-file=10 --restart=always --name eventsink eventsink:$VERSION_TAG node /usr/local/src/eventsink/app.js
#docker run -d -t
